## RG Variables
$ResourceGroupName = "RG-TEST-STGTAJA"
...
$acctKey = ConvertTo-SecureString -String "nN6+d3MSkaENfZTUdKSkO1E5ajZqHU76yv3/+QbdPNH9wr3Eo5Mf1rBElGdJVO6zvo5TjJ1lXJ8R2H/bNbPgcA==" -AsPlainText -Force
$credential = New-Object System.Management.Automation.PSCredential -ArgumentList "Azure\sastdtajafile", $acctKey
New-PSDrive -Name T -PSProvider FileSystem -Root "\\sastdtajafile.file.core.windows.net\fileshare" -Credential $credential -Persist